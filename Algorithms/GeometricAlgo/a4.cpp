...
![square](https://www.geeksforgeeks.org/wp-content/uploads/gq/2014/12/square.png)
*/
...
bool isSquare(Point p1, Point p2, Point p3, Point p4)
{
	...
	// If lengths if (p1, p2) and (p1, p3) are same, then following conditions must met to form a square. 1) Square of length of (p1, p4) is same as twice the square of (p1, p2) 2) Square of length of (p2, p3) is same as twice the square of (p2, p4)
